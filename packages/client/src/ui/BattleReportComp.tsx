...
import { formatNumber, mapOf, mMapOf } from "@spaceship-idle/shared/src/utils/Helper";
   ...
   return (
      <>
         ...
         <div className="panel" style={{ display: "flex", flexDirection: "column", gap: 5 }}>
               ...
               return (
                  <div key={damageType} className="row text-sm">
                     ...
                     <div className="text-space">
                        {formatNumber(stat.rawDamage[damageType] ?? 0)} / {formatNumber(damage)}
                     </div>
                  </div>
               );
            })}
            ...
            <div className="divider mx-10 my5" />
            {mMapOf(stat.actualDamageByBuilding, (building, damage) => {
               return (
