export const EN = {
   ...
   TutorialIssueSkiffClassDirectiveDescHTML: "You need to research all techs in Skiff class to issue a Skiff class directive. Click on the <b>Directive tab</b> (paper scroll icon) on the bottom panel and select a directive that fits your ship.",
