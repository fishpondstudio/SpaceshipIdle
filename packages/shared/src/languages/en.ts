export const EN = {
   ...
   BoostEffect: "Boost",
   AddonLifeTime: "Life Time",
   AddonLifeTimeDesc: "During battle, addons will disappear after reaching life time (%%s)",
   BoostRange: "Range",
   BT: "Booster",
   Build: "Build",
   ...
   ReachedQuantumLimitV2: "Your spaceship is qualified for %% Class spaceship battle",
