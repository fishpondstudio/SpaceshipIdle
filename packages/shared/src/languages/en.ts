export const EN = {
   ...
   EvasionCore: "Evasion Core",
   EvasionCoreDesc: "Equipped module get +%% Evasion",
   HPCore: "HP Core",
   HPCoreDesc: "Equipped module get +%% HP Multiplier",
   DamageCore: "Damage Core",
   DamageCoreDesc: "Equipped module get +%% Damage Multiplier",
   XClass: "%% Class",
   Amount: "Amount",
   Effect: "Effect",
