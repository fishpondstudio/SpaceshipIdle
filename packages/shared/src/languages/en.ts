export const EN = {
   ...
   DamageContrast: "Damage Contrast",
   DamageContrastDesc: "<b>Equipped module</b> gains +%% Damage Multiplier. <b>Adjacent modules</b> also gain +%% Damage Multiplier if they have different damage types from the equipped module",
   PrecisionDiversity: "Precision Diversity",
   PrecisionDiversityDesc:
      "<b>Equipped module</b> gains Precision Strike and +%% Damage Multiplier. <b>Adjacent modules</b> also gain Precision Strike and +%% Damage Multiplier if each one is a different weapon model from both the equipped module and from each other<br><small>Precision Strike: Projectile damage ignores target's evasion</small>",
   ...
   Dhole: "Dhole",
   EMPBlackout: "EMP Blackout",
   EMPBlackoutDesc: "Cause a blackout to the target - fire cooldown is paused",
   NullifyBuff: "Nullify Buff",
   NullifyBuffDesc: "Remove all positive status effects",
   PurifyDebuff: "Purify Debuff",
   PurifyDebuffDesc: "Remove all negative status effects",
   ...
   Evasion: "Evasion",
   EvasionDiversity: "Evasion Diversity",
   EvasionDiversityDesc: "<b>Equipped module</b> gains +%% Evasion. <b>Adjacent modules</b> also gain +%% Evasion if each one is a different weapon model from both the equipped module and from each other",
   ...
   HP: "HP",
   HPArray: "HP Array",
   HPArrayDesc: "<b>Equipped module</b> gains +%% HP Multiplier. <b>Adjacent modules</b> also gain +%% HP Multiplier if they have different series from the equipped module<br><small>e.g. AC76A: Series = 76; MS2B: Series = 2</small>",
   LaserBlockMatrix: "Laser Block Matrix",
   LaserBlockMatrixDesc: "<b>Equipped module</b> gains Laser Block and +%% HP Multiplier. <b>Adjacent modules</b> also gain Laser Block and +%% HP Multiplier if they are unlocked in a different ship class from the equipped module<br><small>Laser Block: Prevent laser projectiles from piercing through</small>",
   HPDiversity: "HP Diversity",
   HPDiversityDesc: "<b>Equipped module</b> gains +%% HP Multiplier. <b>Adjacent modules</b> also gain +%% HP Multiplier if each one is a different weapon model from both the equipped module and from each other",
   ...
   ExplorationDesc: "To explore this star system, you need to either have friended, or have battled all discovered planets",
   ExploreX: "Explore %%",
