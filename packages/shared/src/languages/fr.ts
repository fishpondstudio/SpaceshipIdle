export const FR = {
   ...
   Caracal: "Caracal",
   CatalystActivated: "catalyseur activé",
   CatalystAllXGet: "All %% get",
   CatalystBuildXDifferentY: "Build %% Different %%",
   CatalystCatX: "Cat %%",
   CatalystDamageMultiplier: "+%% Dommage Multiplicateur",
   CatalystHPMultiplier: "+%% PV Multiplicateur",
   CatalystNotActivated: "Catalyseur non activé - Pour activer ce catalyseur, remplissez les conditions requises",
   Category: "Category",
   CatXCatalystSource: "Catalyseur: %%",
   ChangeHandle: "Changement",
   Chemical: "Chimique",
